...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/feature_engine-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10433&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/feature_engine-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `feature_engine` can be installed with:

```
conda install feature_engine
```

It is possible to list all of the versions of `feature_engine` available on your platform with:
